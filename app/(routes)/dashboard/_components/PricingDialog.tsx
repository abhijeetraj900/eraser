    ...
    <DialogContent className="max-w-4xl">
      <DialogHeader>
        ...
        <DialogDescription>
              ...
              <div className="rounded-2xl border border-indigo-600 p-6 shadow-sm ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12">
                ...
                <ul className="mt-6 space-y-2">
                  ...
                  <li className="flex items-center gap-1">
                    ...
                    <span className="text-gray-700">
                      {" "}
                      Exclusive access to Premium Plan{" "}
                    </span>
                  </li>
         ...
         bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white
          hover:bg-indigo-700 hover:ring-1 hover:ring-indigo-700 focus:outline-none focus:ring active:text-indigo-500"
                >
                  Upgrade
                </Link>
              </div>
